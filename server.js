...
/*-----------------public-------------------*/
app.get("", (req, res) => {
  res.redirect(`game/game.html?scene=gic1&id=1&name=ashish&isadmin=true&room=test-hall2`);
});
app.get("/2", (req, res) => {
  res.redirect(`game/game.html?scene=gic1&id=2&name=mohit&isadmin=true&room=test-hall2`);
});
